          ...
          <Row>
            ...
            <Col>
              ...
              <div class="bottom-social-icon d-flex">
                ...
                {centerPathName === "project-details" ?
                  <Link href={`https://api.whatsapp.com/send?phone=919677051111&text=Hi%21+I%27m+interested+${titlewhatsapp}%21+Please+share+more+details.+Thanks%21`}>
                    <Image alt="whatsapp-icon" src="/bottomwhatsapp.svg" width="45" height="45" className="social-icon" />
                  </Link>
                  :
